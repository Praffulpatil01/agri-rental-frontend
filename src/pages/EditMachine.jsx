...
export default function EditMachine() {
    ...
    //         })
    //         .catch(() => {
    //             toast.error("Error fetching machine details");
    //         })
                        ...
                        <div className="flex bg-gray-50 p-1 rounded-xl border border-gray-200">
                            {["Available", "Offline"].map(st => (
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${form.status === st
                                        ? (st === 'Available' ? 'bg-white text-green-700 shadow-sm' : 'bg-white text-gray-700 shadow-sm')
